...
const Header = ({ toggleSidebar }) => {
  ...
  return (
    <header className="relative bg-white/90 backdrop-blur-2xl shadow-xl border-b border-gray-200/60 h-16 sm:h-20 flex items-center justify-between px-3 sm:px-4 md:px-6 lg:px-8 z-20">
